...
def step_2_download_missing_code_db_postgresql():
    ...
    try:
        ...
        missing_db_sql = (
            "select distinct c1.object_name as \"Missing Object Name\","
            " c1.object_type_str as \"Missing Object Type\","
            " c2.file_path as db_obj_src_file\n"
            "from cdt_objects c1, ctv_links ctv, csv_file_objects c2\n"
            "where c1.object_type_str like 'Missing%'\n"
            "and ctv.called_id = c1.object_id\n"
            "and ctv.caller_id = c2.object_id"
        )
